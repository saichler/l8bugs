    ...
    window.Layer8DModuleFilter = {
        ...
        load: async function(bearerToken) {
            try {
                ...
                var prefix = (typeof Layer8DConfig !== 'undefined' && Layer8DConfig.getApiPrefix) ? Layer8DConfig.getApiPrefix() : '/erp';
                var resp = await fetch(prefix + '/0/ModConfig?body=' + query, {
                    headers: {
        ...
        save: async function(disabledPaths, bearerToken) {
            try {
                ...
                var savePrefix = (typeof Layer8DConfig !== 'undefined' && Layer8DConfig.getApiPrefix) ? Layer8DConfig.getApiPrefix() : '/erp';
                var resp = await fetch(savePrefix + '/0/ModConfig', {
                    method: method,
                    headers: {
                        'Authorization': 'Bearer ' + bearerToken,
                        'Content-Type': 'application/json'
